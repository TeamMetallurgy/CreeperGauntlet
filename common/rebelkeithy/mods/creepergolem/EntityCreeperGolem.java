...
public class EntityCreeperGolem extends EntityMob
{
    /**
    ...
    public EntityCreeperGolem(World par1World)
    {
        super(par1World);
        ...
        this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityPlayer.class, 16, true, true));
