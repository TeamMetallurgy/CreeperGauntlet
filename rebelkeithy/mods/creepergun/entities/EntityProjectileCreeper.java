...
public class EntityProjectileCreeper extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityProjectileCreeper(World par1World)
    {
        super(par1World);
    ...
    public EntityProjectileCreeper(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
