...
public class ModelExplodingIronGolem extends ModelBase
{
    ...
    public ModelExplodingIronGolem()
    {
        this(0.0F);
    }

    public ModelExplodingIronGolem(float par1)
    {
        this(par1, -7.0F);
    }

    public ModelExplodingIronGolem(float par1, float par2)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
    	EntityExplodingCreature entityirongolem = (EntityExplodingCreature)par1EntityLiving;
        ...
        {
            int j = 0;//entityirongolem.getHoldRoseTick();
